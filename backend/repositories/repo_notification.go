...
// func (repo *NotifRepository) CreateNotification(notification *models.Notifications) *models.ErrorJson {
// 	query := `INSERT INTO notifications (notif_id, recieved_Id, sender_Id, seen, Notif_type, notif_state, content) VALUES (?,?,?,?,?,?,?)`
// 	stmt, err := repo.db.Prepare(query)
// 	if err != nil {
// 		return &models.ErrorJson{Status: 500, Message: fmt.Sprintf("%v", err)}
// 	}
// 	defer stmt.Close()
// 	if _, err = stmt.Exec(notification.Id, notification.Recieved_Id, notification.Sender_Id, "false", notification.Type, notification.Status, notification.Content); err != nil {
// 		return &models.ErrorJson{Status: 500, Message: fmt.Sprintf("%v", err)}
// 	}
// 	return nil
// }

// // func (repo *NotifRepository) IsLoggedInUser(token string) (*models.IsLoggedIn, *models.ErrorJson) {
